...
// GET logout
app.get('/logout', routes.requiresLogin, routes.logout);

// GET chatroom
app.get('/', routes.requiresLogin, routes.home);
app.get('/client', routes.requiresLogin, function (req, res) {
  res.sendfile(__dirname + '/client.js');
});

// GET public access to the chatroom
app.get('/public', routes.home);
app.get('/public/client', function (req, res) {
  res.sendfile(__dirname + '/client.js');
});
